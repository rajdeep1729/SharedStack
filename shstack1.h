...
#define Max_Stacks 10//Max Stacks that can be accesed at a time
...
typedef struct Stack_descriptor//stack descriptor data structure
{
 ...
 int element_size;//size of the element in the stack 
...
void shstackpush(int index,int value);//function for pushing into stack
int shstackpop(int index);//function for popping from the stack
